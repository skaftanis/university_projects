...
//MEΡΟΣ 3
	...
	//Αν είναι ο πρώτος παίχτης, τότε γράφει στη SM πρώτος όλα τα στοιχεία
...
//------------------
				...
				//η κρίσημη περιοχή τελείωνει. έχει γίνει η εγγραφή στη SM και έχουμε λάβει τις τιμές από τη δεύτερη SM
				//Τις έχουμε αποθηκεύσει σε πίνακες. Όλο αυτό γίνεται πριν έρθει το αίτημα, γι αυτό χρησιμοποιείται και αυτός
				//ο semaphore ως mutex
				sem_op.sem_num = 0;
				sem_op.sem_op = 1;
				sem_op.sem_flg = 0;
